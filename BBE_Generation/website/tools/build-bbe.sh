...
rm -rf bbe_gen_tool
mkdir -p bbe_gen_tool
mkdir -p bbe_gen_tool/withfrontmatter
mkdir -p bbe_gen_tool/withoutfrontmatter
#export GOPATH=$3
...
go run tools/ballerinaByExample/tools/generate.go "tools/target/dependencies/ballerina-examples" v1-0 bbe_gen_tool
