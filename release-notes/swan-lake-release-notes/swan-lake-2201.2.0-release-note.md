...
- Changed the ServiceDescriptor annotation to Descriptor (Please update the service annotation if stub files are regenerated for the existing gRPC services)
