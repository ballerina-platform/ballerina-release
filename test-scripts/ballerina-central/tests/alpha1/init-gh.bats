...
@test "Create package '$PACKAGE_NAME:$VERSION' from ALPHA1." {
  run $ALPHA1/bin/bal new $PACKAGE_NAME
...
@test "Build package '$PACKAGE_NAME:$VERSION' from ALPHA1" {
  cd "$PACKAGE_NAME-$VERSION"
  run $ALPHA1/bin/bal build
