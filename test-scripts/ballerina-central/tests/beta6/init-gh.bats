...
@test "Create package '$PACKAGE_NAME:$VERSION' from BETA6." {
  run $BETA6/bin/bal new $PACKAGE_NAME -t lib
...
@test "Build package '$PACKAGE_NAME:$VERSION' from BETA6" {
  cd "$PACKAGE_NAME-$VERSION"
  run $BETA6/bin/bal pack
