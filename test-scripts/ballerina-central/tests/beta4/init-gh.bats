...
@test "Create package '$PACKAGE_NAME:$VERSION' from BETA4." {
  run $BETA4/bin/bal new $PACKAGE_NAME -t lib
...
@test "Build package '$PACKAGE_NAME:$VERSION' from BETA4" {
  cd "$PACKAGE_NAME-$VERSION"
  run $BETA4/bin/bal pack
