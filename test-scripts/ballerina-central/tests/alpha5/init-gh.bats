...
@test "Create package '$PACKAGE_NAME:$VERSION' from ALPHA5." {
  run $ALPHA5/bin/bal new $PACKAGE_NAME -t lib
...
@test "Build package '$PACKAGE_NAME:$VERSION' from ALPHA5" {
  cd "$PACKAGE_NAME-$VERSION"
  run $ALPHA5/bin/bal build -c
